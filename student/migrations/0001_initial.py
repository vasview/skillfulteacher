    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reviews', to='student.student')),
            ],
        ),
        migrations.CreateModel(
            name='StudentKlass',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='parents', to='student.student')),
            ],
            options={
